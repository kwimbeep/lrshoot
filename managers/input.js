...
function InputManager() {
  ...
  this.getMouseCoordinates = function(g, e) {
    var r = g.canvas.getBoundingClientRect();
    return {
      x: (e.clientX - r.left) / g.scaleFactor,
      y: (e.clientY - r.top) / g.scaleFactor
    };
  };
...
InputManager.prototype.handleMouse = function(e, type) {
  var c = this.getMouseCoordinates(game, e);
  this.events.push({
    type: type,
    x: c.x,
    y: c.y
